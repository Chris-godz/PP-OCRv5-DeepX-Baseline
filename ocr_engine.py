...
def create_ocr_models(version='v4'):
    """
    Create detection, classification, and recognition models based on version
    
    Args:
        version (str): Model version ('v4' or 'v5')
    ...
    if version == 'v4':
        ...
        raise ValueError(f"Unsupported version: {version}. Use 'v4' or 'v5'")
...
def create_ocr_workers(version='v4', num_workers=3):
    """
